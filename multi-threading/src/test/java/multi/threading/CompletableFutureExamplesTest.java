...
public class CompletableFutureExamplesTest {
  ...
  @Test
  public void whenRunningCompletableFutureInDedicatedThreadPool_thenGetMethodWaitsForResult() throws InterruptedException,
      ExecutionException {
  ...
  @SneakyThrows
  private void sleepSecondsNoThrows(long duration) {
    System.out.println("Waiting "+ duration +" sec.");
  ...
  @Test
  public void whenRunningCompletableFutureAsynchronously_thenGetMethodWaitsForResult() throws InterruptedException,
      ExecutionException {
